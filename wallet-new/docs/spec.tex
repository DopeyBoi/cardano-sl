...
%
\intertext{Use Lemma~\ref{lem:balance_props_union} to
...
Lemma~\ref{lem:balance_props_minus} to distribute
...
= ~ & (u, \mathit{pending}) : \mathit{cs} & \text{\{ Lemma~\ref{lem:updatePending_is_filter} \}}
\end{align*}
\end{proof}
